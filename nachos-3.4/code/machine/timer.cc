...
//-------------------------------------------------------------------------
//This method is the method to set the first
//interrupt after finishing the main method
//we can't forcast the time, main method takes,
//so we have to set the first interupt after
//main thread is finished(main::172)
//-------------------------------------------------------------------------
void
Timer::Set_first_Interrupt(){
...
Timer::TimeOfNextInterrupt()
{
    ...
    else if(Selected_List == First_List)
    	return Quantom_Slice;
    else if(Selected_List == Second_List)
    	return 2*Quantom_Slice;
    else if( Selected_List == Third_List)
    	return 4*Quantom_Slice;
}
